...
Used in the data-insight-viz workflow to ensure chart configurations are valid before
embedding in reports.
"""

from __future__ import annotations  # PEP 604 annotations (`dict | None`) on Python 3.9
